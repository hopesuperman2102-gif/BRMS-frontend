          ...
          >
            ...
            <Typography
              sx={{
                fontSize: "0.6875rem",
                fontFamily: fonts.mono,
                color: c.pass ? colors.lightTextMid : colors.lightTextLow,
      ...
      <FormCard>
        ...
        {success && (
          <StyledAlert
            ...
            sx={{
              background: brmsTheme.colors.statusUsingBg,
              border: `1px solid ${brmsTheme.colors.statusUsingBorder}`,
              color: brmsTheme.colors.statusUsingText,
              "& .MuiAlert-icon": {
                color: brmsTheme.colors.statusUsingDot,
                fontSize: "1rem",
              },
            }}
          >
